    ...
    <div className="container mx-auto px-4 py-10 flex flex-col gap-14">
      <div className='flex flex-col items-center justify-center py-10 gap-2'>
        <img 
          ...
          alt="" 
          className='opacity-20 dark:opacity-20 h-[50px] lg:h-[80px] xl:h-[100px]' 
        />
        <img 
          src={isDarkMode ? images.whiteVector : images.vector} 
          alt="" 
          className='opacity-60 dark:opacity-60 h-[50px] lg:h-[80px] xl:h-[100px]' 
        />
        <img 
          src={isDarkMode ? images.whiteVector : images.vector} 
          alt="" 
          className='opacity-100 dark:opacity-100 h-[50px] lg:h-[80px] xl:h-[100px]' 
        />
      </div>
